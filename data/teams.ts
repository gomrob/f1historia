...
export const TEAMS: Team[] = [{
  ...
  },
  {
    ...
    color: '#358C75',
    founded: 2021,
    bio: 'Aston Martin Aramco F1 Team, anteriormente conocido como Racing Point y Force India, compite en Fórmula 1 desde 2021 bajo la icónica marca británica de superdeportivos y la propiedad de Lawrence Stroll. Fernando Alonso se unió al equipo en 2023.',
    logoUrl: 'https://upload.wikimedia.org/wikipedia/commons/0/03/Aston_Martin_F1_Team_logo_2024.jpg',
    championships: 0,
    wins: 0,
    poles: 1,
    podiums: 4,
    ...
    color: '#EB0A1E',
    founded: 2016,
    bio: 'El único equipo norteamericano de la parrilla, fundado por Gene Haas en 2016. Es el primer equipo estadounidense nuevo en F1 desde 1986. Compite con motores Ferrari y ha demostrado ser competitivo desde su debut.',
    logoUrl: 'https://upload.wikimedia.org/wikipedia/commons/1/18/TGR_Haas_F1_Team_Logo_%282026%29.svg',
    championships: 0,
    wins: 0,
    poles: 0,
    podiums: 0,
    ...
    color: '#F50537',
    founded: 1993,
    bio: 'Fundado como Sauber en 1993, el equipo ha competido bajo los nombres BMW Sauber, Sauber, Alfa Romeo y Kick Sauber. En 2026 se convierte en equipo de fábrica Audi, marcando la entrada del fabricante alemán en la Fórmula 1 con motor propio.',
    logoUrl: 'https://upload.wikimedia.org/wikipedia/commons/3/30/Audif1.com_logo17.svg',
    championships: 0,
    wins: 1,
    poles: 1,
    podiums: 5,
    ...
    color: '#6692FF',
    founded: 2006,
    bio: 'El segundo equipo de Red Bull Racing, fundado en 2006 como Scuderia Toro Rosso. Rebautizado como AlphaTauri en 2020 y como Visa Cash App Racing Bulls en 2024. Ha formado pilotos como Vettel, Verstappen y Sainz.',
    logoUrl: 'https://upload.wikimedia.org/wikipedia/en/thumb/2/2b/VCARB_F1_logo.svg/250px-VCARB_F1_logo.svg.png',
    championships: 0,
    wins: 2,
    poles: 1,
    podiums: 4,
    ...
    color: '#9C8A5E',
    founded: 2025,
    bio: 'Cadillac F1 Team es el primer equipo completamente nuevo en entrar en la Fórmula 1 desde Haas en 2016. Aprobado por la FIA y la FOM para competir desde 2026, representa el regreso de General Motors a la Fórmula 1 bajo la marca Cadillac.',
    logoUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/f/fc/Cadillac_Wordmark.svg/250px-Cadillac_Wordmark.svg.png',
    championships: 0,
    wins: 0,
    poles: 0,
    podiums: 0,
