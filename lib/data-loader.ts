...
// ─── Season entries (pre-built by scripts/fetch-season-entries.js) ───────────

/**
 * Returns the pre-built team/driver entries for a season, read from
 * data/json/season-entries/{year}.json (generated by scripts/fetch-season-entries.js).
 * Returns an empty array if the file does not exist yet.
 */
export function getSeasonEntries(year: number): SeasonEntry[] {
  return readJson<SeasonEntry[]>(`season-entries/${year}.json`) ?? []
}
